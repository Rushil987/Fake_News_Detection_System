...
class Stage1Pipeline:
    def __init__(self):
        ...
        self.auth_filter = AuthenticityFilter(self.collector.trusted_sources)
    ...
    def _run_domain_check(self, url, domain):
        # This is a simplified check for web app integration
        # For full analysis, call detect_phishing(url) and parse results
        # Here, we just check for redirection and add a note
